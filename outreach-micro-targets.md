# Micro-target outreach — verified family/owner-run leads (fresh lead-gen)

Claude's end-to-end batch: **newly-found** tiny UK firms (family-owned / owner-operator, founder does the
work + the bidding) that bid public-sector occasionally, **have a public email**, and can't afford
enterprise bid tools — i.e. genuinely *desperate for a free tender read*. Each entry is verified from
public sources (no fabricated emails/names) and comes with a ready-to-send, personalised nudge.
...
> **ID scheme:** provisional `MT-##` (micro-target). These live here, not in `crm/leads.csv`, so they don't
> clash with Codex's reserved `L-0401+`. When migrating to the CRM, give them fresh `L-` ids and dedupe again.

### Wave 1 — family/owner-run compliance & maintenance trades
*7 found · 6 kept (4 PERFECT, 2 GOOD) · 1 dropped as duplicate.*
Dropped: **Yates Jetting Ltd** — duplicate of existing **L-0360** (same domain + email). Note: **Midland Fire Ltd**
(`midland-fire.co.uk`) is a *different* firm from existing **L-0168 Midland Fire Security Services** (`midlandfiresecurity.co.uk`) — near-identical name, distinct company/email.

---

#### MT-01 · Midland Fire Ltd · to: sales@midland-fire.co.uk · PERFECT
*Small family fire-safety firm (est. 1985), ~3 engineers; services schools, colleges, libraries, government facilities. Source: midland-fire.co.uk*
...
#### MT-02 · Cropper Grounds Maintenance · to: info@grounds-maintenance.com · PERFECT
*Family-owned grounds/gritting firm (est. 2001), North Staffs; named council client (Uttoxeter Town Council), gritting for hospitals & schools. Source: grounds-maintenance.com*
...
#### MT-03 · Exjet · to: info@exjet.co.uk · PERFECT
*Second-generation family drainage firm (est. 1986), Devon; MD Robin Dowell (publicly listed). Serves local councils and MoD. Source: exjet.co.uk/about-us*
...
#### MT-04 · H2O Hygiene Ltd · to: info@h2ohygiene.co.uk · PERFECT
*Family-run water-hygiene firm, Walsall (2023 Family Business Awards winner). Council portfolio + schools legionella + care homes. Email verified via LCA directory (site address Cloudflare-obfuscated). Sources: h2ohygiene.co.uk; legionellacontrol.org.uk directory*
...
#### MT-05 · Call2Drain · to: info@call2drain.co.uk · GOOD
*Family-run drainage specialist (est. 2005), Tunbridge Wells; CHAS-accredited, states LA/public-sector clients. Source: call2drain.co.uk/about*
...
#### MT-06 · Browns Landscape Solutions Ltd · to: info@brownslandscapes.com · GOOD
*Family-run landscaping/grounds firm, Leighton Buzzard; local-authority school grounds contracts + housing-association work. Source: brownslandscapes.com/school-grounds-maintenance*
