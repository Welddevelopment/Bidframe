...
def test_depends_on_order_preserving_union():
    a = {"raw_id": "a", "text": "x", "source_page": 1, "source_clause": "S",
         "source_excerpt": "x", "char_start": 0,
         "type": "optional", "is_gating": False, "category": "x", "confidence": 0.80,
         "depends_on": ["req-0001", "req-0002"]}
    b = {"raw_id": "b", "text": "x", "source_page": 1, "source_clause": "S",
         "source_excerpt": "x", "char_start": 1,
         "type": "optional", "is_gating": False, "category": "x", "confidence": 0.70,
         "depends_on": ["req-0002", "req-0003"]}
    assert merge_group([a, b])["depends_on"] == ["req-0001", "req-0002", "req-0003"]
