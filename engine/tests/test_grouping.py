...
def test_different_requirements_same_page_clause_blocked_by_token_floor():
    # Two DIFFERENT mandatory disqualifiers sharing boilerplate AND a page/clause.
...
def test_non_transitive_chain_is_refused():
    # REAL chain: a~b and b~c clear the gate, a~c does NOT. Naive transitive
    # closure would wrongly fuse {a,b,c}; the all-pairs guard must not.
