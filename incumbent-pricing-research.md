# Incumbent pricing → the hard £-saved number (Impact, 30%)

> Researched 2026-07-04 against UK bid-writing market pricing. Purpose: give the pitch a **hard,
> defensible £ number** for the speed-up/impact criterion, without overclaiming what Bidframe replaces.

## What the market charges (sourced)

| Thing | Price | Source |
|---|---|---|
| **Bid writer day rate** (contractor, median) | **£375 / day** | IT Jobs Watch |
| Bid-writing consultant hourly | from **£110 + VAT / hour** | Tsaks Consulting |
| **Outsourced tender *review*** (the service closest to our first-read) | **from £950 / tender** | Glaxtons |
| **Full outsourced bid write**, one tender | **£2,000–£8,000** (avg **~£4,000 + VAT**) | Executive Compass / JGP |
| Framework application (e.g. CWAS3) | from **£10,000** | Tsaks |
| **In-house bid writer salary** | **£35k–£50k / year** (avg ~£37.5k; experienced ~£52k) | Glassdoor / talent.com / Bid Solutions |
| **Time to prepare a bid** | **2–8 weeks** (standard) · 6–16+ weeks (complex) | Sparrow Genie / procurement guidance |

## The honest £-saved (what Bidframe actually replaces)
...
*Sources: [IT Jobs Watch — Bid Writer rates](https://www.itjobswatch.co.uk/contracts/uk/bid%20writer.do) · [Executive Compass — cost of writing a tender](https://executivecompass.co.uk/blog/bid-management/what-is-the-cost-of-writing-a-tender/) · [Glaxtons pricing (review from £950)](https://www.glaxtons.co.uk/pricing/) · [Tsaks Consulting fees](https://tsaksconsulting.com/fees-uk-bid-writing/) · [Bid Solutions 2025 salary survey](https://bidsolutions.com/bid-recruitment/salary-guidance/) · [Glassdoor bid writer salary](https://www.glassdoor.co.uk/Salaries/bid-writer-salary-SRCH_KO0,10.htm).*
