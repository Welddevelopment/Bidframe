...
>
> Map of commit `affffdf` · 2026-07-03T16:12:41+01:00
...
|------|-------|-------|------------|
| **frontend** | 157 | 54,444 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 492 | 26,552 | Root — docs, config, role briefs |
...
graph LR
  ...
  n7[RequirementsContext.tsx] --> n94[answer-store.ts]
  ...
  n94[answer-store.ts] --> n8[requirement.ts]
...
*780 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
