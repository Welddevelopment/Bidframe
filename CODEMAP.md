...
>
> Map of commit `1f2b329` · 2026-07-02T20:41:09+01:00
...
|------|-------|-------|------------|
| **frontend** | 138 | 49,981 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
| **backend** | 19 | 2,773 | Backend — FastAPI (PDF ingest, extraction, REST API) |
| **engine** | 65 | 4,732 | Engine — reconcile / eval / answer-draft pipeline + tests |
...
*666 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
