...
>
> Map of commit `7275998` · 2026-07-02T20:23:48Z
...
|------|-------|-------|------------|
| **frontend** | 140 | 50,444 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
| **backend** | 19 | 2,887 | Backend — FastAPI (PDF ingest, extraction, REST API) |
| **engine** | 65 | 4,909 | Engine — reconcile / eval / answer-draft pipeline + tests |
...
| **comms** | 5 | 1,786 | Comms — async agent message boards |
