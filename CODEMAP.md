...
>
> Map of commit `783928c` · 2026-07-04T11:33:59+01:00
...
|------|-------|-------|------------|
| **frontend** | 178 | 60,449 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 577 | 32,754 | Root — docs, config, role briefs |
...
*887 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
