...
>
> Map of commit `d2d74b2` · 2026-07-03T16:35:01+01:00
...
|------|-------|-------|------------|
| **frontend** | 159 | 54,971 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 495 | 26,722 | Root — docs, config, role briefs |
...
graph LR
  ...
  n19[PitchDeck.tsx] --> n95[TrailMap.tsx]
  ...
  n7[RequirementsContext.tsx] --> n96[answer-store.ts]
  ...
  n96[answer-store.ts] --> n8[requirement.ts]
...
*785 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
