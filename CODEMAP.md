...
>
> Map of commit `41af2ff` · 2026-07-04T14:25:37+01:00
...
|------|-------|-------|------------|
| **frontend** | 178 | 60,896 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 587 | 34,337 | Root — docs, config, role briefs |
...
graph LR
  ...
  n7[RequirementsContext.tsx] --> n110[answer-store.ts]
  ...
  n110[answer-store.ts] --> n9[requirement.ts]
...
*900 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
