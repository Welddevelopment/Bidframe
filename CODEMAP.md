...
>
> Map of commit `8eb8f79` · 2026-07-03T16:25:57+01:00
...
|------|-------|-------|------------|
| **frontend** | 158 | 54,649 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
graph LR
  ...
  n18[pitch/page.tsx] --> n19[PitchDeck.tsx]
  n18[pitch/page.tsx] --> n7[RequirementsContext.tsx]
  n18[pitch/page.tsx] --> n8[requirement.ts]
  n20[review/page.tsx] --> n3[AuthGate.tsx]
  n20[review/page.tsx] --> n21[MatrixView.tsx]
  n20[review/page.tsx] --> n22[mock-requirements.ts]
  n23[tenders/page.tsx] --> n2[AppMain.tsx]
  n23[tenders/page.tsx] --> n4[DocumentHeader.tsx]
  n23[tenders/page.tsx] --> n24[TendersList.tsx]
  n25[thank-you/page.tsx] --> n14[BrandLogo.tsx]
  n26[upload/page.tsx] --> n2[AppMain.tsx]
  n26[upload/page.tsx] --> n3[AuthGate.tsx]
  n26[upload/page.tsx] --> n4[DocumentHeader.tsx]
  n26[upload/page.tsx] --> n27[UploadDropzone.tsx]
  n28[AccountMenu.tsx] --> n12[AuthContext.tsx]
  n29[AnswerCard.tsx] --> n30[AnswerPanel.tsx]
  n29[AnswerCard.tsx] --> n31[AnswerStateBadge.tsx]
  n29[AnswerCard.tsx] --> n32[CategoryTag.tsx]
  n29[AnswerCard.tsx] --> n33[ConfidenceIndicator.tsx]
  n29[AnswerCard.tsx] --> n34[OpenQuestions.tsx]
  n29[AnswerCard.tsx] --> n35[answers.ts]
  n29[AnswerCard.tsx] --> n8[requirement.ts]
  n36[AnswerFilterBar.tsx] --> n37[ExportMenu.tsx]
  n36[AnswerFilterBar.tsx] --> n35[answers.ts]
  n36[AnswerFilterBar.tsx] --> n8[requirement.ts]
  n30[AnswerPanel.tsx] --> n31[AnswerStateBadge.tsx]
  n30[AnswerPanel.tsx] --> n7[RequirementsContext.tsx]
  n30[AnswerPanel.tsx] --> n8[requirement.ts]
  n31[AnswerStateBadge.tsx] --> n8[requirement.ts]
  n38[AnswerWorkspace.tsx] --> n29[AnswerCard.tsx]
  n38[AnswerWorkspace.tsx] --> n8[requirement.ts]
  n1[AnswersBody.tsx] --> n36[AnswerFilterBar.tsx]
  n1[AnswersBody.tsx] --> n38[AnswerWorkspace.tsx]
  n1[AnswersBody.tsx] --> n39[AutofillButton.tsx]
  n1[AnswersBody.tsx] --> n40[CapabilityUpload.tsx]
  n1[AnswersBody.tsx] --> n41[NoTenderLoaded.tsx]
  n1[AnswersBody.tsx] --> n42[ReadinessLedger.tsx]
  n1[AnswersBody.tsx] --> n7[RequirementsContext.tsx]
  n1[AnswersBody.tsx] --> n35[answers.ts]
  n1[AnswersBody.tsx] --> n15[api.ts]
  n3[AuthGate.tsx] --> n12[AuthContext.tsx]
  n3[AuthGate.tsx] --> n15[api.ts]
  n39[AutofillButton.tsx] --> n7[RequirementsContext.tsx]
  n39[AutofillButton.tsx] --> n15[api.ts]
  n40[CapabilityUpload.tsx] --> n7[RequirementsContext.tsx]
  n32[CategoryTag.tsx] --> n43[categoryStyle.ts]
  n44[CommandPalette.tsx] --> n45[matrix-derive.ts]
  n44[CommandPalette.tsx] --> n46[source-doc.ts]
  n44[CommandPalette.tsx] --> n47[triage.ts]
  n48[ComplianceMatrix.tsx] --> n32[CategoryTag.tsx]
  n48[ComplianceMatrix.tsx] --> n33[ConfidenceIndicator.tsx]
  n48[ComplianceMatrix.tsx] --> n49[dedupe.ts]
  n48[ComplianceMatrix.tsx] --> n45[matrix-derive.ts]
  n48[ComplianceMatrix.tsx] --> n47[triage.ts]
  n48[ComplianceMatrix.tsx] --> n8[requirement.ts]
  n6[DemoView.tsx] --> n14[BrandLogo.tsx]
  n6[DemoView.tsx] --> n48[ComplianceMatrix.tsx]
  n6[DemoView.tsx] --> n50[GatingHero.tsx]
  n6[DemoView.tsx] --> n51[GraphView.tsx]
  n6[DemoView.tsx] --> n52[SourceVerifyOverlay.tsx]
  n6[DemoView.tsx] --> n53[DemoScrolly.tsx]
  n6[DemoView.tsx] --> n54[BookDemoButton.tsx]
  n6[DemoView.tsx] --> n55[BotanicalSprig.tsx]
  n6[DemoView.tsx] --> n56[DrawOn.tsx]
  n6[DemoView.tsx] --> n57[SiteFooter.tsx]
  n6[DemoView.tsx] --> n58[FernFrond.tsx]
  n6[DemoView.tsx] --> n59[TreelineDivider.tsx]
  n6[DemoView.tsx] --> n7[RequirementsContext.tsx]
  n6[DemoView.tsx] --> n15[api.ts]
  n6[DemoView.tsx] --> n47[triage.ts]
  n4[DocumentHeader.tsx] --> n28[AccountMenu.tsx]
  n4[DocumentHeader.tsx] --> n14[BrandLogo.tsx]
  n4[DocumentHeader.tsx] --> n60[SectionNav.tsx]
  n4[DocumentHeader.tsx] --> n7[RequirementsContext.tsx]
  n4[DocumentHeader.tsx] --> n43[categoryStyle.ts]
  n4[DocumentHeader.tsx] --> n47[triage.ts]
  n61[EvidenceLibrary.tsx] --> n7[RequirementsContext.tsx]
  n37[ExportMenu.tsx] --> n62[export-response.ts]
  n37[ExportMenu.tsx] --> n8[requirement.ts]
  n63[FocusMode.tsx] --> n64[RequirementPanel.tsx]
  n63[FocusMode.tsx] --> n47[triage.ts]
  n63[FocusMode.tsx] --> n8[requirement.ts]
  n65[GapInterview.tsx] --> n31[AnswerStateBadge.tsx]
  n65[GapInterview.tsx] --> n32[CategoryTag.tsx]
  n65[GapInterview.tsx] --> n34[OpenQuestions.tsx]
  n65[GapInterview.tsx] --> n7[RequirementsContext.tsx]
  n50[GatingHero.tsx] --> n7[RequirementsContext.tsx]
  n50[GatingHero.tsx] --> n49[dedupe.ts]
  n50[GatingHero.tsx] --> n8[requirement.ts]
  n51[GraphView.tsx] --> n32[CategoryTag.tsx]
  n51[GraphView.tsx] --> n33[ConfidenceIndicator.tsx]
  n51[GraphView.tsx] --> n7[RequirementsContext.tsx]
  n51[GraphView.tsx] --> n15[api.ts]
  n51[GraphView.tsx] --> n43[categoryStyle.ts]
  n51[GraphView.tsx] --> n66[structure.ts]
  n51[GraphView.tsx] --> n8[requirement.ts]
  n67[MarksView.tsx] --> n7[RequirementsContext.tsx]
  n67[MarksView.tsx] --> n66[structure.ts]
  n67[MarksView.tsx] --> n8[requirement.ts]
  n21[MatrixView.tsx] --> n68[AnimatedNumber.tsx]
  n21[MatrixView.tsx] --> n2[AppMain.tsx]
  n21[MatrixView.tsx] --> n69[ApprovalStamp.tsx]
  n21[MatrixView.tsx] --> n70[BulkActionBar.tsx]
  n21[MatrixView.tsx] --> n44[CommandPalette.tsx]
  n21[MatrixView.tsx] --> n48[ComplianceMatrix.tsx]
  n21[MatrixView.tsx] --> n4[DocumentHeader.tsx]
  n21[MatrixView.tsx] --> n63[FocusMode.tsx]
  n21[MatrixView.tsx] --> n50[GatingHero.tsx]
  n21[MatrixView.tsx] --> n41[NoTenderLoaded.tsx]
  n21[MatrixView.tsx] --> n71[PdfSourceView.tsx]
  n21[MatrixView.tsx] --> n72[RequirementDrawer.tsx]
  n21[MatrixView.tsx] --> n64[RequirementPanel.tsx]
  n21[MatrixView.tsx] --> n73[RequirementSpine.tsx]
  n21[MatrixView.tsx] --> n7[RequirementsContext.tsx]
  n21[MatrixView.tsx] --> n15[api.ts]
  n21[MatrixView.tsx] --> n74[export-matrix-xlsx.ts]
  n21[MatrixView.tsx] --> n45[matrix-derive.ts]
  n21[MatrixView.tsx] --> n46[source-doc.ts]
  n21[MatrixView.tsx] --> n47[triage.ts]
  n21[MatrixView.tsx] --> n8[requirement.ts]
  n34[OpenQuestions.tsx] --> n7[RequirementsContext.tsx]
  n34[OpenQuestions.tsx] --> n8[requirement.ts]
  n71[PdfSourceView.tsx] --> n49[dedupe.ts]
  n75[ProcessingView.tsx] --> n15[api.ts]
  n42[ReadinessLedger.tsx] --> n35[answers.ts]
  n72[RequirementDrawer.tsx] --> n64[RequirementPanel.tsx]
  n72[RequirementDrawer.tsx] --> n8[requirement.ts]
  n64[RequirementPanel.tsx] --> n30[AnswerPanel.tsx]
  n64[RequirementPanel.tsx] --> n69[ApprovalStamp.tsx]
  n64[RequirementPanel.tsx] --> n32[CategoryTag.tsx]
  n64[RequirementPanel.tsx] --> n33[ConfidenceIndicator.tsx]
  n64[RequirementPanel.tsx] --> n52[SourceVerifyOverlay.tsx]
  n64[RequirementPanel.tsx] --> n7[RequirementsContext.tsx]
  n64[RequirementPanel.tsx] --> n15[api.ts]
  n64[RequirementPanel.tsx] --> n46[source-doc.ts]
  n64[RequirementPanel.tsx] --> n8[requirement.ts]
  n73[RequirementSpine.tsx] --> n33[ConfidenceIndicator.tsx]
  n73[RequirementSpine.tsx] --> n47[triage.ts]
  n52[SourceVerifyOverlay.tsx] --> n71[PdfSourceView.tsx]
  n52[SourceVerifyOverlay.tsx] --> n8[requirement.ts]
  n10[StructureView.tsx] --> n51[GraphView.tsx]
  n10[StructureView.tsx] --> n67[MarksView.tsx]
  n10[StructureView.tsx] --> n41[NoTenderLoaded.tsx]
  n10[StructureView.tsx] --> n72[RequirementDrawer.tsx]
  n10[StructureView.tsx] --> n7[RequirementsContext.tsx]
  n10[StructureView.tsx] --> n15[api.ts]
  n10[StructureView.tsx] --> n66[structure.ts]
  n10[StructureView.tsx] --> n8[requirement.ts]
  n24[TendersList.tsx] --> n7[RequirementsContext.tsx]
  n24[TendersList.tsx] --> n15[api.ts]
  n27[UploadDropzone.tsx] --> n75[ProcessingView.tsx]
  n27[UploadDropzone.tsx] --> n76[RegisterPreview.tsx]
  n27[UploadDropzone.tsx] --> n7[RequirementsContext.tsx]
  n27[UploadDropzone.tsx] --> n15[api.ts]
  n53[DemoScrolly.tsx] --> n77[ScrollyRail.tsx]
  n53[DemoScrolly.tsx] --> n78[ScrollyStage.tsx]
  n53[DemoScrolly.tsx] --> n79[steps.ts]
  n53[DemoScrolly.tsx] --> n54[BookDemoButton.tsx]
  n77[ScrollyRail.tsx] --> n79[steps.ts]
  n78[ScrollyStage.tsx] --> n69[ApprovalStamp.tsx]
  n78[ScrollyStage.tsx] --> n32[CategoryTag.tsx]
  n78[ScrollyStage.tsx] --> n33[ConfidenceIndicator.tsx]
  n78[ScrollyStage.tsx] --> n50[GatingHero.tsx]
  n78[ScrollyStage.tsx] --> n80[sample.ts]
  n78[ScrollyStage.tsx] --> n79[steps.ts]
  n80[sample.ts] --> n8[requirement.ts]
  n81[ClosingArrival.tsx] --> n54[BookDemoButton.tsx]
  n81[ClosingArrival.tsx] --> n56[DrawOn.tsx]
  n81[ClosingArrival.tsx] --> n82[Reveal.tsx]
  n81[ClosingArrival.tsx] --> n83[PineBranch.tsx]
  n81[ClosingArrival.tsx] --> n84[Seal.tsx]
  n81[ClosingArrival.tsx] --> n59[TreelineDivider.tsx]
  n85[ForestHeroLayers.tsx] --> n84[Seal.tsx]
  n86[HeroResolve.tsx] --> n48[ComplianceMatrix.tsx]
  n86[HeroResolve.tsx] --> n50[GatingHero.tsx]
  n86[HeroResolve.tsx] --> n7[RequirementsContext.tsx]
  n86[HeroResolve.tsx] --> n47[triage.ts]
  n17[Landing.tsx] --> n14[BrandLogo.tsx]
  n17[Landing.tsx] --> n33[ConfidenceIndicator.tsx]
  n17[Landing.tsx] --> n54[BookDemoButton.tsx]
  n17[Landing.tsx] --> n81[ClosingArrival.tsx]
  n17[Landing.tsx] --> n87[CredibilityBand.tsx]
  n17[Landing.tsx] --> n56[DrawOn.tsx]
  n17[Landing.tsx] --> n85[ForestHeroLayers.tsx]
  n17[Landing.tsx] --> n86[HeroResolve.tsx]
  n17[Landing.tsx] --> n88[HowItWorks.tsx]
  n17[Landing.tsx] --> n89[ProductShots.tsx]
  n17[Landing.tsx] --> n90[ProofScrolly.tsx]
  n17[Landing.tsx] --> n82[Reveal.tsx]
  n17[Landing.tsx] --> n57[SiteFooter.tsx]
  n17[Landing.tsx] --> n91[TrailDescent.tsx]
  n17[Landing.tsx] --> n83[PineBranch.tsx]
  n17[Landing.tsx] --> n92[PressedLeaf.tsx]
  n17[Landing.tsx] --> n84[Seal.tsx]
  n17[Landing.tsx] --> n59[TreelineDivider.tsx]
  n89[ProductShots.tsx] --> n69[ApprovalStamp.tsx]
  n90[ProofScrolly.tsx] --> n68[AnimatedNumber.tsx]
  n90[ProofScrolly.tsx] --> n93[ProofNumbers.tsx]
  n90[ProofScrolly.tsx] --> n82[Reveal.tsx]
  n57[SiteFooter.tsx] --> n14[BrandLogo.tsx]
  n57[SiteFooter.tsx] --> n54[BookDemoButton.tsx]
  n57[SiteFooter.tsx] --> n83[PineBranch.tsx]
  ...
  n19[PitchDeck.tsx] --> n50[GatingHero.tsx]
  n19[PitchDeck.tsx] --> n51[GraphView.tsx]
  n19[PitchDeck.tsx] --> n94[PitchScene.tsx]
  n19[PitchDeck.tsx] --> n7[RequirementsContext.tsx]
  ...
  n7[RequirementsContext.tsx] --> n95[answer-store.ts]
  n7[RequirementsContext.tsx] --> n15[api.ts]
  n7[RequirementsContext.tsx] --> n8[requirement.ts]
  n22[mock-requirements.ts] --> n8[requirement.ts]
  n95[answer-store.ts] --> n8[requirement.ts]
  n35[answers.ts] --> n47[triage.ts]
  n35[answers.ts] --> n8[requirement.ts]
  n15[api.ts] --> n8[requirement.ts]
  n49[dedupe.ts] --> n8[requirement.ts]
  n74[export-matrix-xlsx.ts] --> n33[ConfidenceIndicator.tsx]
  n74[export-matrix-xlsx.ts] --> n62[export-response.ts]
  n74[export-matrix-xlsx.ts] --> n46[source-doc.ts]
  n74[export-matrix-xlsx.ts] --> n8[requirement.ts]
  n62[export-response.ts] --> n8[requirement.ts]
  n45[matrix-derive.ts] --> n49[dedupe.ts]
  n45[matrix-derive.ts] --> n66[structure.ts]
  n45[matrix-derive.ts] --> n47[triage.ts]
  n45[matrix-derive.ts] --> n8[requirement.ts]
  n46[source-doc.ts] --> n15[api.ts]
  n46[source-doc.ts] --> n8[requirement.ts]
  n66[structure.ts] --> n8[requirement.ts]
  n47[triage.ts] --> n8[requirement.ts]
  n96[error.tsx]
```
...
- `outputs/bidframe-canva-pitch-deck.pptx`
- `outputs/bidframe-canva-pitch-deck.pptx.inspect.ndjson`
...
- *(+54 binary/asset file(s))*

---

*808 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
