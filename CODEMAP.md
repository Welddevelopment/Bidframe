...
>
> Map of commit `9d8d5e0` · 2026-07-03T02:44:11+01:00
...
| **backend** | 20 | 3,146 | Backend — FastAPI (PDF ingest, extraction, REST API) |
| **engine** | 71 | 5,897 | Engine — reconcile / eval / answer-draft pipeline + tests |
...
| **root** | 449 | 23,407 | Root — docs, config, role briefs |
...
*718 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
