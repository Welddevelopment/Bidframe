...
>
> Map of commit `86c19c9` · 2026-07-02T19:38:57+01:00
...
|------|-------|-------|------------|
| **frontend** | 138 | 49,509 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
| **backend** | 19 | 2,736 | Backend — FastAPI (PDF ingest, extraction, REST API) |
| **engine** | 64 | 4,508 | Engine — reconcile / eval / answer-draft pipeline + tests |
...
*665 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
