...
>
> Map of commit `9512a01` · 2026-07-07T15:30:26+01:00
...
|------|-------|-------|------------|
| **frontend** | 195 | 73,103 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
graph LR
  ...
  n37[ActivityFeed.tsx] --> n8[requirement.ts]
...
- `demoimprovement.md`
- `deploy/hfspace.Dockerfile`
- `deploy/hfspace.README.md`
- `deploy/push-hf-space.ps1`
- `deploy/stage-hf-space.ps1`
- `features.md`
...
*969 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
