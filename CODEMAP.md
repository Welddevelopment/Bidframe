...
>
> Map of commit `97e57e3` · 2026-07-02T21:05:59Z
...
|------|-------|-------|------------|
| **frontend** | 140 | 50,419 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
| **backend** | 19 | 2,926 | Backend — FastAPI (PDF ingest, extraction, REST API) |
| **engine** | 68 | 5,268 | Engine — reconcile / eval / answer-draft pipeline + tests |
| **prompts** | 6 | 713 | Prompts — LLM prompt specs (extraction, classification, answers, gaps) |
| **gold** | 6 | 297 | Eval gold-set — hand-labelled requirements for accuracy measurement |
| **data** | 17 | 0 | Data — tender source PDFs (not parsed here) |
| **comms** | 5 | 1,928 | Comms — async agent message boards |
| **docs** | 3 | 1,663 | Docs — plans & specs |
| **ci** | 1 | 62 | CI — GitHub Actions |
| **tooling** | 1 | 516 | Tooling — repo scripts (incl. this map generator) |
| **root** | 407 | 21,350 | Root — docs, config, role briefs |
...
graph LR
  ...
  n4[DocumentHeader.tsx] --> n58[AnimatedNumber.tsx]
  n4[DocumentHeader.tsx] --> n14[BrandLogo.tsx]
  n4[DocumentHeader.tsx] --> n59[SectionNav.tsx]
  ...
  n60[EvidenceLibrary.tsx] --> n7[RequirementsContext.tsx]
  n35[ExportMenu.tsx] --> n61[export-response.ts]
  n35[ExportMenu.tsx] --> n8[requirement.ts]
  n62[FocusMode.tsx] --> n63[RequirementPanel.tsx]
  n62[FocusMode.tsx] --> n45[triage.ts]
  n62[FocusMode.tsx] --> n8[requirement.ts]
  n64[GapInterview.tsx] --> n29[AnswerStateBadge.tsx]
  n64[GapInterview.tsx] --> n30[CategoryTag.tsx]
  n64[GapInterview.tsx] --> n32[OpenQuestions.tsx]
  n64[GapInterview.tsx] --> n7[RequirementsContext.tsx]
  ...
  n49[GraphView.tsx] --> n65[structure.ts]
  n49[GraphView.tsx] --> n8[requirement.ts]
  n66[MarksView.tsx] --> n7[RequirementsContext.tsx]
  n66[MarksView.tsx] --> n65[structure.ts]
  n66[MarksView.tsx] --> n8[requirement.ts]
  n19[MatrixView.tsx] --> n58[AnimatedNumber.tsx]
  ...
  n19[MatrixView.tsx] --> n62[FocusMode.tsx]
  ...
  n19[MatrixView.tsx] --> n63[RequirementPanel.tsx]
  ...
  n70[RequirementDrawer.tsx] --> n63[RequirementPanel.tsx]
  n70[RequirementDrawer.tsx] --> n8[requirement.ts]
  n63[RequirementPanel.tsx] --> n28[AnswerPanel.tsx]
  n63[RequirementPanel.tsx] --> n67[ApprovalStamp.tsx]
  n63[RequirementPanel.tsx] --> n30[CategoryTag.tsx]
  n63[RequirementPanel.tsx] --> n31[ConfidenceIndicator.tsx]
  n63[RequirementPanel.tsx] --> n50[SourceVerifyOverlay.tsx]
  n63[RequirementPanel.tsx] --> n7[RequirementsContext.tsx]
  n63[RequirementPanel.tsx] --> n15[api.ts]
  n63[RequirementPanel.tsx] --> n44[source-doc.ts]
  n63[RequirementPanel.tsx] --> n8[requirement.ts]
  ...
  n10[StructureView.tsx] --> n66[MarksView.tsx]
  ...
  n10[StructureView.tsx] --> n65[structure.ts]
  ...
  n72[export-matrix-xlsx.ts] --> n61[export-response.ts]
  n72[export-matrix-xlsx.ts] --> n44[source-doc.ts]
  n72[export-matrix-xlsx.ts] --> n8[requirement.ts]
  n61[export-response.ts] --> n8[requirement.ts]
  n43[matrix-derive.ts] --> n47[dedupe.ts]
  n43[matrix-derive.ts] --> n65[structure.ts]
