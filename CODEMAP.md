...
>
> Map of commit `448e894` · 2026-07-03T16:55:31+01:00
...
|------|-------|-------|------------|
| **frontend** | 160 | 55,484 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 496 | 26,893 | Root — docs, config, role briefs |
...
graph LR
  ...
  n97[answer-store.ts] --> n8[requirement.ts]
...
*787 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
